...
kube::codegen::gen_helpers \
    --boilerplate "${REPO_ROOT}/hack/boilerplate/boilerplate.generatego.txt" \
    "${REPO_ROOT}/cluster-autoscaler/apis/autoscalinglimitrange"
...
kube::codegen::gen_client \
    --output-pkg k8s.io/autoscaler/cluster-autoscaler/apis/autoscalinglimitrange/client \
    --output-dir "${REPO_ROOT}/cluster-autoscaler/apis/autoscalinglimitrange/client" \
    --boilerplate "${REPO_ROOT}/hack/boilerplate/boilerplate.generatego.txt" \
    --with-watch \
    --with-applyconfig \
    "${REPO_ROOT}/cluster-autoscaler/apis/autoscalinglimitrange"
