...
func (c *AutoscalingV1beta1Client) AutoscalingLimitRanges(namespace string) AutoscalingLimitRangeInterface {
	return newAutoscalingLimitRanges(c, namespace)
}
